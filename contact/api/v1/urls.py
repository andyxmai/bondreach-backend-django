...
router.register(r'contacts-companies', api.ContactCompanyViewSet, base_name='contacts-companies')
router.register(r'contacts-companies-downloads', api.DownloadContactCompanyViewSet, base_name='contacts-companies-downloads')
